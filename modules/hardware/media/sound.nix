...
in {
  options.workstation.sound.enable = lib.mkEnableOption "PipeWire sound configuration";
  ...
  config = lib.mkIf cfg.enable (
    lib.mkMerge [
      ...
      (lib.optionalAttrs (lib.hasAttrByPath [ "services" "pipewire" "extraLadspaPackages" ] options) {
